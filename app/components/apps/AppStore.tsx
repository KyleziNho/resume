...
export const apps: AppData[] = [
  ...
  },
  {
    ...
    progressNotes: 'live on the app store! now integrated into a bath uni module where students handle marketing and business development. excited to see where they take it.',
    videoId: '1068684400',
